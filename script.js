...
button.addEventListener('mouseover', function() {
  if (jumpCount < 100) {
    ...
    const maxX = (window.innerWidth - buttonRect.width) * 0.25;
    const maxY = (window.innerHeight - buttonRect.height) * 0.25;
    ...
    button.style.transform = `translate(${prevX + deltaX * 2.5}px, ${prevY + deltaY * 2}px)`;
